...
(function () {
  ...
  const committee = [
    ...
    { name: "Jahangir Alam", role: "Meta-Reviewer", aff: "CRIM-Montreal" },
    ...
    { name: "Ruixiang Zhang", role: "Meta-Reviewer", aff: "Apple MLR" },
    { name: "Ahmad Rashid", role: "Meta-Reviewer", aff: "University of Waterloo & Vector Institute" },
    ...
    { name: "Mojtaba Valipour", role: "Reviewer", aff: "BMO" },
    { name: "Md Zarif Hossain", role: "Reviewer", aff: "Southern Illinois University" },
    { name: "Parsa Omidi", role: "Reviewer", aff: "Huawei Technologies Canada" },
    { name: "Shangyu Wu", role: "Reviewer", aff: "City University of Hong Kong" },
    { name: "Bharat Runwal", role: "Reviewer", aff: "IBM Research" },
    { name: "Neal Lawton", role: "Reviewer", aff: "Capital One" },
    { name: "Huiqiang Jiang", role: "Reviewer", aff: "Microsoft Research" },
    { name: "Gnana Praveen Rajasekhar", role: "Reviewer", aff: "École de technologie supérieure" },
    ...
    { name: "Rajat Ghosh", role: "Reviewer", aff: "Nutanix" },
    { name: "Abderrahim Fathan", role: "Reviewer", aff: "CRIM-Montreal" },
    { name: "Haz Sameen Shahgir", role: "Reviewer", aff: "University of California Riverside" },
    { name: "Sai Ganesh Mirishkar", role: "Reviewer", aff: "IIIT Hyderabad" },
    { name: "Namrata Shivagunde", role: "Reviewer", aff: "University of Massachusetts Lowell" },
    ...
    { name: "Michael Metel", role: "Reviewer", aff: "Huawei Noah's Ark Lab" },
    { name: "Hossein Rajabzadeh", role: "Reviewer", aff: "University of Waterloo" },
    { name: "Xinyu Wang", role: "Reviewer", aff: "McGill University" },
    { name: "Mahdi Biparva", role: "Reviewer", aff: "Huawei Canada" },
    { name: "Saber Malekmohammadi", role: "Reviewer", aff: "University of Waterloo" },
    { name: "Coleman Hooper", role: "Reviewer", aff: "UC Berkeley" },
    { name: "Ning Shi", role: "Reviewer", aff: "University of Alberta" },
    { name: "Moshe Kimhi", role: "Reviewer", aff: "Technion, IBM" },
    { name: "Yujie Pan", role: "Reviewer", aff: "Intel" },
    { name: "Raffy Fahim", role: "Reviewer", aff: "Microsoft" },
    { name: "Yaser Keneshloo", role: "Reviewer", aff: "Wizard Commerce Inc." },
    ...
    { name: "Fabian Paischer", role: "Reviewer", aff: "Johannes Kepler University, Linz" },
    { name: "Luo Yu", role: "Reviewer", aff: "Intel" },
    ...
    { name: "Ali Saheb Pasand", role: "Reviewer", aff: "McGill University" },
    { name: "Mofetoluwa Adeyemi", role: "Reviewer", aff: "Upfeat" },
    { name: "Zijin Gu", role: "Reviewer", aff: "Apple" },
    { name: "Richard He Bai", role: "Reviewer", aff: "Apple" },
    { name: "Maureen de Seyssel", role: "Reviewer", aff: "Apple" },
    { name: "Zakaria Aldeneh", role: "Reviewer", aff: "Apple" },
    { name: "Santiago Cuervo", role: "Reviewer", aff: "Apple MLR" },
    { name: "Debojyoti Dutta", role: "Reviewer", aff: "Nutanix" },
    { name: "Sheikh Shams Azam", role: "Reviewer", aff: "Apple" },
    { name: "Yu Fu", role: "Reviewer", aff: "University of California, Riverside" },
    { name: "Omid Ghahroodi", role: "Reviewer", aff: "QCRI" },
    { name: "Erfan Shayegani", role: "Reviewer", aff: "University of California, Riverside" },
    { name: "Amin Edraki", role: "Reviewer", aff: "Huawei" },
    { name: "Irina Kezele", role: "Reviewer", aff: "Huawei" },
    { name: "Hoda Rezaee Kaviani", role: "Reviewer", aff: "Huawei" },
